...
const steps: Step[] = [
  ...
  },
  {
    ...
    label: "AI Processing",
    description:
      "Our AI analyzes the content of your PDF, extracting key information and insights.",
  },
  {
    icon: <FileOutput size={64} strokeWidth={1.5} />,
    label: "Get Summary",
    description:
      "Receive a concise, easy-to-read summary of your PDF, ready to be downloaded or shared.",
  },
];
